...
--7. 매니저 없는 사원의 이름을 표시하세요. XXXXXXXXXXXXXXXXXXXXXXXX
SELECT ename
FROM employee
...
--8. 매니저 있는 사원의 이름을 표시하세요. XXXXXXXXXXXXXXXXXXXXXXXX
SELECT ename
FROM employee
...
--9. BLAKE와 동일한 부서에 속한 사원의 이름과 입사일을 표시하는 질의를 작성하세요.(단 BLAKE는제외)
...
--15. 평균 급여보다 많은 급여를 받고 이름에서 M이 포함된 사원과 같은 부서에서 근무하는 사원의사원번호, 이름, 급여를 출력하세요.
